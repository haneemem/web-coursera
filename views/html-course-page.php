...
$enrol_id = enroll_user('HTML', $_SESSION['uname']);
...
$r_stat = getResourcesStatus($enrol_id, 'html');
?>
    <!---------------- Navigation Bar --------------->
    <header>
    ...
    <script type="text/javascript">
        function onCheck(resource_id) {
            ...
            xhttp.onreadystatechange = function() {
             ...
             xhttp.send("resource_id=r"+resource_id+"&course_name="+"html"+"&enrol_id="+enrollId);
...
function showResult(str) {
  ...
  xmlhttp.open("GET","../livesearch-contents.php?q="+str+"&c_name=html",true);
  xmlhttp.send();
}
</script>
</body>
