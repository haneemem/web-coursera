...
<?php
        ...
        $enrol_id = enroll_user('PYTHON', $_SESSION['uname']);
        ...
        $r_stat = getResourcesStatus($enrol_id, 'python');
    ...
    <?php
            ...
            $count = get_count('PYTHON');
    ?>
    <!----------------  Web Coursera Intro  --------------->
    <section id="banner">
        <div class="banner1">
            <div class="slider">
                <img src="../assets/wp4605385-yellow-and-blue-wallpapers.jpg" id="slideImg">
            </div>
            <div class="overlay">
                <div class="content">
                    <p class="promo-title">Python</p>
                    <p>Python is a high level object oriented programming language.</p>
                   <p> Python is used for Machine Learning, Data Visualization, developing websites and much more.</p>
                    <!-----
    ...
    <script type="text/javascript">
        function onCheck(resource_id) {
            ...
            xhttp.onreadystatechange = function() {
             ...
             xhttp.send("resource_id=r"+resource_id+"&course_name="+"python"+"&enrol_id="+enrollId);
    ...
    <section id="reference">
        ...
        <table>
            <?php foreach ($json['python']['resources'] as $x) {?>  
                    <tr>
    ...
    <section id="lectures">
        ...
        <table>
            <?php foreach ($json['python']['shortVideos'] as $x) {?>  
                <tr>
        ...
        <table>
            <?php foreach ($json['python']['mediumVideos'] as $x) {?>  
                <tr>
                    <td><i class="fas fa-film"></i><a class="links" href="<?php echo $x['Link'] ?>"><?php echo $x['Title'] ?></a></td>
                    <td><?php echo $x['Length']?></td>
                    <td><input type="checkbox" name="<?php echo $resource_no++;?>" id="" onclick = "onCheck(this.name);" <?php echo $r_stat[$resource_no] == 1 ? "checked" : "";?> ></td>
        ...
        <table>
            <?php foreach ($json['python']['longVideos'] as $x) {?>  
                <tr>
                    <td><i class="fas fa-film"></i><a class="links" href="<?php echo $x['Link'] ?>"><?php echo $x['Title'] ?></a></td>
                    <td><?php echo $x['Length']?></td>
                    <td><input type="checkbox" name="<?php echo $resource_no++;?>" id="" onclick = "onCheck(this.name);" <?php echo $r_stat[$resource_no] == 1 ? "checked" : "";?> ></td>
...
function showResult(str) {
  ...
  xmlhttp.open("GET","../livesearch-contents.php?q="+str+"&c_name=python",true);
  xmlhttp.send();
}
</script>
</body>
